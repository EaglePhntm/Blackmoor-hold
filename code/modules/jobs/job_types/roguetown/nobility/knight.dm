...
/datum/outfit/job/roguetown/knight/heavy/pre_equip(mob/living/carbon/human/H)
	...
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/riding, 1, TRUE)	//Too heavy for horses.
...
/datum/outfit/job/roguetown/knight/irregularknight/pre_equip(mob/living/carbon/human/H)
	..()	
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/swords, 4, TRUE) //Swords and knives class.
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/knives, 4, TRUE)	
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/whipsflails, 4, TRUE) //Whips can work as a light class weapon.	
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/shields, 3, TRUE)	
	H.mind.adjust_skillrank_up_to(/datum/skill/misc/riding, 2, TRUE)	
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/crossbows, 4, TRUE) //Bows fit a light/speedy class pretty well, gave them ranged options.
	H.mind.adjust_skillrank_up_to(/datum/skill/combat/bows, 4, TRUE)
	...
	switch(weapon_choice)
		...
		if("Greataxe + Sling")
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/slings, 4, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/axes, 4, TRUE)
			r_hand = /obj/item/rogueweapon/greataxe/steel
			backl = /obj/item/gwstrap
