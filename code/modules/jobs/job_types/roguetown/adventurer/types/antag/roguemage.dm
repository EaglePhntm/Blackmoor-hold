...
/datum/outfit/job/roguetown/bandit/roguemage/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/polearms, 3, TRUE) // Jman Polearms, for better parrying without making them bandit level 
		H.mind.adjust_skillrank_up_to(/datum/skill/combat/axes, 2, TRUE) // They get apprentice in a wide spread of weapons for synergy with conjuration, especially if they take virtues
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/misc/athletics, 2, TRUE) // Standards for athletics is 3, give them 2
