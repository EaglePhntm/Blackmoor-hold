...
/datum/outfit/job/roguetown/wretch/deserter/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Abandoned Post") // The dreaded MaA Footman / Cavalryman without town-buffs. HORRIFYING. ZOOOOUNDS, EGAAAADS! - Average armory raider equipment, too. Minus the red. Otherwise, a worse Disgraced.
			...
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/wrestling, 4, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/combat/unarmed, 4, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/climbing, 4, TRUE) // Better at climbing away than your average MaA. Only slightly.
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/swimming, 3, TRUE) // Worse at swimming than the above class.
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/reading, 1, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/athletics, 4, TRUE)
			H.mind.adjust_skillrank_up_to(/datum/skill/misc/riding, 3, TRUE) // That saiga was stolen. Probably.
