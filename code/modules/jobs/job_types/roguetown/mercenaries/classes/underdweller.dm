...
/datum/outfit/job/roguetown/mercenary/underdweller/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/alchemy, 2, TRUE)	//Gets this for bomb making.
		...
		H.mind.adjust_skillrank_up_to(/datum/skill/craft/smelting, 2, TRUE)	//Accompanies mining; they know how to smelt, not make armor though.
