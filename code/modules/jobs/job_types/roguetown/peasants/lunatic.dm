/datum/job/roguetown/lunatic
	...
	max_pq = null
	tutorial = "The Lunatic, shunned by society and a magnet for misfortune. Your task is simple yet perilous: survive by any means, though your very existence invites danger from every corner. It is said that Blackmoor drives those most familiar with it, the most insane."
